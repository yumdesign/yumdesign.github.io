		...
		// Check if this is a post or page, if it has a thumbnail, and if it's a big one
			if ( is_singular() &&
				...
				// Houston, we have a new header image!
						...
						<!-- <img src="<?php echo get_template_directory_uri(); ?>/images/headers/nubaseball-thumbnail.jpg" class="headerimage" width="<?php echo HEADER_IMAGE_WIDTH; ?>" height="<?php echo HEADER_IMAGE_HEIGHT; ?>" alt="" /> --><!-- end headerimage -->
					<?php endif; ?>
					<div class="clear"></div>
